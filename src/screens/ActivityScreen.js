...
const styles = StyleSheet.create({
  ...
  filterChipTextActive: { color: '#0a0a0f', fontWeight: '700' },
  ...
  monthFooterRight: { fontSize: 13, fontWeight: '800', color: '#00d4aa' },

  itemContainer: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#1a1a24', marginHorizontal: 20,
  ...
  empty: {
    ...
    backgroundColor: '#1a1a24', margin: 20, borderRadius: 24,
